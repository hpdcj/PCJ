 ...
 */
public class MessageValueGetResponse extends Message {
    ...
    private MessageValueGetResponse(int groupId, int requestNum, int requesterThreadId) {
        this();
    ...
    public MessageValueGetResponse(int groupId, int requestNum, int requesterThreadId, Exception exception) {
        this(groupId, requestNum, requesterThreadId);
