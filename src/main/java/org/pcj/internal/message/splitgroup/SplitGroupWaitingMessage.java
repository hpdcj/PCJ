 ...
 */
public final class SplitGroupWaitingMessage extends Message {

    private int groupId;
    private int round;

    public SplitGroupWaitingMessage() {
        super(MessageType.SPLIT_GROUP_WAITING);
    }

    public SplitGroupWaitingMessage(int groupId, int round) {
        this();
