...
public class AsyncPutStates {
    ...
    public State create() {
        ...
        AsyncPutFuture future = new AsyncPutFuture();
    ...
    public static class State {
        ...
        private final AsyncPutFuture future;

        private State(int requestNum, AsyncPutFuture future) {
