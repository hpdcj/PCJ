...
final public class PCJ extends InternalPCJ {
    ...
    /**
     * Gets identifier of current PCJ Thread in the global group. Identifiers are consecutive numbers that start with 0.
     *
     ...
     *
     * @param shareableEnumClass Enum class that represents storage shareable variables
     * @return Object associated with Storage (type of value from enum annotation)
     */
    public static Object getStorageObject(Class<? extends Enum<?>> shareableEnumClass) {
        return PcjThread.getCurrentThreadData().getStorages().getStorage(shareableEnumClass);
    }
     ...
     * Synchronous barrier.
     * <p>
     * Wrapper for {@link PCJ#asyncBarrier()}.
     * <p>
    ...
    /**
     * Starts asynchronous barrier with one peer PCJ Thread. Given {@code threadId}
     * should be different from current PCJ Thread id, otherwise the exception is thrown.
     * <p>
     ...
     * <p>
     * Increases modification count of the shareable variable by one.
     *
     * @param <T>      type of variable
     ...
     * Asynchronous execution operation.
     * <p>
     * Executes associated function on specified thread from global group without returing value.
     *
     * @param threadId  peer PCJ Thread
     * @param asyncTask function to be executed
    ...
    public static Group join(String name) {
        ...
        return InternalPCJ.join(myThreadId, name);
    }
}
