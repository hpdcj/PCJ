...
//        }
//
//        System.out.println(PCJ.myId() + "> EasyTest.main()");
//        System.out.println(PCJ.myId() + "> myNode:   " + PCJ.myId());
//        PCJ.barrier();
//        System.out.println(PCJ.myId() + "> numNodes:   " + PCJ.threadCount());
//
//        System.out.println(PCJ.myId() + "> myNode: " + PCJ.myId() + ", numNodes: " + PCJ.threadCount());
//        Group g = PCJ.join("group" + (PCJ.myId() % 2));
//        System.out.println(PCJ.myId() + "> I'm in group " + (PCJ.myId() % 2) + " as " + g.myId() + " (size: " + g.threadCount() + ")");
//        PCJ.barrier();
//        System.out.println(PCJ.myId() + "> In group '" + g.getGroupName() + "': " + g.threadCount() + " [groupNodeId:" + g.myId() + "/globalNodeId:" + PCJ.myId() + "]");
//        if (PCJ.myId() == 0) {
//            System.out.println(PCJ.myId() + "> broadcasting...");
//            PCJ.broadcast("A", 0b010101);
//            System.out.println(PCJ.myId() + "> syncWith(1)");
//            PCJ.barrier(1);
//            System.out.println(PCJ.myId() + "> synced(1)");
//        }
//        if (PCJ.myId() == 1) {
//            System.out.println(PCJ.myId() + "> syncWith(0)");
//            PCJ.barrier(0);
//            System.out.println(PCJ.myId() + "> synced(0)");
//        }
...
//            System.out.println(PCJ.myId() + "> Put 0x10 by 0 to node 1 to variable 'A'");
//            PCJ.put(1, "A", 0x10);
//        }
//
//        PCJ.barrier();
...
//
//        if (PCJ.threadCount() >= 2 && PCJ.myId() == 0) {
//            System.out.println(PCJ.myId() + "> Get 'A' by 0 from 1");
//            A = PCJ.get(1, "A");
//        }
//
//        PCJ.barrier();
...
//            Btest b = PCJ.get(1, "B");
//            //  System.out.println(PCJ.myId()+"> b.c = " + b.c.length);
...
//        }
//
//        System.out.println(PCJ.myId() + "> atomic: " + atomic.get());
//    }
//}
